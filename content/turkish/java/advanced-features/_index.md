---
date: 2026-02-16
description: GroupDocs.Search for Java ile indeks'e belge eklemeyi, tarih aralığı,
  faceted arama ve dosya uzantısı filtrelemeyi nasıl uygulayacağınızı öğrenin.
title: Belgeleri İndexe Ekle – GroupDocs.Search Java Kılavuzu
type: docs
url: /tr/java/advanced-features/
weight: 8
---

# Belgeleri İndekse Ekle – GroupDocs.Search Java Kılavuzu
