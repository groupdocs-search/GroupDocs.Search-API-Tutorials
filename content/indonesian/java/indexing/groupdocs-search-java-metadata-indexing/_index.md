...
Menambahkan dokumen ke indeks dengan cepat dan andal adalah tulang punggung dari setiap aplikasi modern berbasis pencarian. Baik Anda membangun repositori hukum, basis pengetahuan dukungan pelanggan, atau portal dokumen internal, **metadata indexing** memungkinkan Anda *mencari dokumen berdasarkan metadata* seperti penulis, judul, atau tag khusus. Dalam tutorial ini Anda akan belajar cara mengonfigurasi pengaturan indeks, membuat indeks yang berfokus pada metadata, menambahkan file Anda, dan menjalankan pencarian yang tepat—semua dengan GroupDocs.Search untuk Java.

## Quick Answers
- **Apa tujuan utama metadata indexing?** Ini memungkinkan pencarian cepat berdasarkan properti dokumen daripada konten teks penuh.  
- **Metode mana yang menambahkan file ke indeks?** `index.add(YOUR_DOCUMENTS_FOLDER);`  
- **Apakah saya dapat mencari berdasarkan bidang metadata khusus?** Ya, setelah bidang tersebut diindeks Anda dapat menanyakannya secara langsung.  
...
**Tips:**  
- Pastikan jalur folder benar dan aplikasi memiliki izin baca.  
...
- Anda juga dapat **search pdf by author** dengan menggunakan nama penulis sebagai string kueri.
...
- **Pembaruan Inkremental:** Gunakan `index.addOrUpdate()` untuk file baru atau yang berubah alih-alih membangun ulang seluruh indeks.  
- **Pemrosesan Batch:** Saat menangani ribuan file, tambahkan mereka dalam batch yang lebih kecil untuk menjaga penggunaan memori tetap rendah.  
- **Validasi Metadata:** Pastikan dokumen sumber benar-benar berisi metadata yang akan Anda kueri (mis., bidang penulis dalam PDF).  

## Pertimbangan Kinerja
- **Penyesuaian Memori:** Sesuaikan ukuran heap JVM (`-Xmx`) berdasarkan volume metadata yang diindeks.  
- **Penyimpanan Teroptimasi:** Secara periodik panggil `index.optimize()` untuk memadatkan indeks dan meningkatkan kecepatan kueri.  

## Masalah Umum dan Solusinya

| Masalah | Solusi |
|-------|----------|
| **Tidak ada hasil yang dikembalikan** | Pastikan bahwa bidang metadata yang Anda harapkan memang ada dalam file sumber. |
| **Kesalahan izin** | Pastikan proses Java memiliki akses baca ke folder dokumen dan direktori indeks. |
| **Kesalahan out‑of‑memory** | Tingkatkan ukuran heap JVM atau proses `add` secara batch untuk memproses file dalam grup yang lebih kecil. |
...
A: Secara rutin perbarui indeks Anda, gunakan penambahan inkremental, dan sesuaikan pengaturan memori JVM.

## Sumber Daya

- **Dokumentasi:** [GroupDocs.Search Java Documentation](https://docs.groupdocs.com/search/java/)  
...
- **Repositori GitHub:** [GroupDocs.Search GitHub](https://github.com/groupdocs-search/GroupDocs.Search-for-Java)  
- **Forum Dukungan Gratis:** [GroupDocs Community Forum](https://forum.groupdocs.com/c/search/10)  
