---
date: 2026-03-06
description: Dowiedz się, jak włączyć wyszukiwanie przybliżone w GroupDocs.Search
  dla Javy, obejmując instalację, licencjonowanie i tworzenie pierwszego rozwiązania
  przeszukiwalnego z dopasowaniem przybliżonym.
title: Jak włączyć wyszukiwanie przybliżone w GroupDocs.Search – Samouczek wprowadzający
  dla Javy
type: docs
